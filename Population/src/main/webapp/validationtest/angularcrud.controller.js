(function()
{
	...
	//Controller Part  
	app.controller("populationEntryController", populationEntryController);
	
	
// function CountryController($scope, $http){
	function populationEntryController(populationEntryService, $scope, $http){
		...
		$scope.submitCountry = function() {
			...
			*/
			populationEntryService.insertData(method, url,$scope)
			.then(_success, _error);
			console.log("insertData..");
			console.log("scope.submitted*** "); console.log($scope.submitted);
