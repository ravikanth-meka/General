...
public class StoreRegisterTestUsingMockito {
   ...
   /* @Mock
    ...
    public final void verifyBasic() throws ItemsNotFoundException{
    	 ...
    	 try {
 			stub(id.getInventoryDataMap()).toReturn(new HashMap<String, Inventory>());
